...
import background from "../../../Screenshots/businessmeeting.png";
import footerImage from "../../../Screenshots/designpeople.png";

const DesignStation = () => {
  const buttons = [
    {
      text: "Hire Graphic Designer",
      link: "https://www.fiverr.com/categories/graphics-design/brand-style-guides?source=drop_down_filters&ref=gig_price_range%3A0%2C10",
      alignment: "ml-0"
    },
  ];
  ...
  return (
    ...
    >
      ...
      <img
        src={footerImage}
        alt="Footer"
        className="absolute bottom-0 right-5 md:right-10 lg:right-16 w-[90%] sm:w-[70%] md:w-[50%] lg:w-[48%] hidden sm:block"
      />
